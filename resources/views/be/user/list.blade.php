        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="dataTable">
                ...
                <tr>
                    ...
                    <td>{{$item->phone}}</td>
                    <td>
                        <button array="{{$item}}" id="{{$item->id}}" class="edituser btn btn-link">Sửa</button>
                        <a class="btn btn-link" href="{{route('admin.user.delete',['id'=>$item->id])}}" onclick="return confirm('Bạn có muốn xoá ?')">Xóa</a>
                    </td>
                </tr>
                @endforeach
                </tbody>
