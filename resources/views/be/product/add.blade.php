    ...
    <form action="{{route('admin.product.add')}}" method="post" role="form" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="form-group col-4">
                <label for="">Tên sản phẩm</label> <span id="errorname" class="text-danger">@error('name'){{$message}}@enderror</span>
        ...
        <div class="form-group">
            <label for="">Mô tả sản phẩm</label><span id="errorcontent" style="color: red">@error('content'){{$message}}@enderror</span>
